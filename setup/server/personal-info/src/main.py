...
from .models import PersonalInfoResponse, PersonalInfoUpdate
from .repository import PersonalInfoRepository
...
def create_app() -> FastAPI:
    ...
    def get_repository() -> PersonalInfoRepository:
        return PersonalInfoRepository()

    def get_service(repository: PersonalInfoRepository = Depends(get_repository)) -> PersonalInfoService:
    ...
    @app.get("/personal-info/contact", response_model=Dict[str, Any])
    async def get_contact_info(
        ...
        Returns:
            Dict: Contact information (email, phone, social links)
        """
        try:
